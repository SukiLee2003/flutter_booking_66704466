...
void initState(){
  ...
  Future saveBooking() async {
    ...
    var url = Uri.parse(
        "http://localhost/flutter_booking_66704466/php_api/add_booking.php");
        ...
        child: Column(
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: Image.network(
                "http://localhost/flutter_booking_66704466/php_api/images/$roomImage",
